<script lang="ts">
	...
	const BetaSpec = data.BetaSpec.paths;
	const V3Spec = data.V3Spec.paths;
...
<div class="flex flex-col gap-4 h-full overflow-hidden overflow-y-auto">
